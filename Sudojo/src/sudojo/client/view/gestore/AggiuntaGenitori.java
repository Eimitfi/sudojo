...
public class AggiuntaGenitori extends AbstractView{
	//Dubbio su questa classe, perché l'aggiunta/modifica dei genitori viene fatta attraverso CreaAffiliatoViewModelInterface e
	//ModificaAffiliatoViewModelInterface, quindi non so se bisognerebbe agganciarla al viewmodel oppure no. Nel caso non saprei
	//nemmeno come farlo in grafica perché appunto dovrebbe già essere parte di aggiunta/modifica affiliato ed essendo una classe
