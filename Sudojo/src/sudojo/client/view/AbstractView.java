...
public abstract class AbstractView implements Observer<Subject>{
	...
	//[daniel]: vero x draw e bind, x il resto secondo me meglio lasciarla astratta perché potremmo accorgerci che ci sono operazioni comuni alle maschere da fattorizzare (in AbstractViewModel mi è successo)
