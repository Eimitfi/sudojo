...
public class HomeDirettoreController {
	...
	public void show_presenze(ActionEvent event) throws IOException {
		root = (Pane) FXMLLoader.load(getClass().getResource("MascheraVisualizzaPresenze.fxml"));
		stage = (Stage) ((Node) event.getSource()).getScene().getWindow();
		scene = new Scene(root);
		stage.setScene(scene);
		stage.show();
	...
	public void write_budopass(ActionEvent event) throws IOException {
		root = (Pane) FXMLLoader.load(getClass().getResource("MascheraCompilaBudopass.fxml"));
		stage = (Stage) ((Node) event.getSource()).getScene().getWindow();
		scene = new Scene(root);
		stage.setScene(scene);
		stage.show();
